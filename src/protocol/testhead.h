...
//
//#define DP_AUDIO_TASK_STARTID 0
//#define DP_VIDEO_TASK_STARTID 256
//#define DP_AV_TASK_STARTID 512
//
//#else
//	//...default（预留）
//#endif
...
//
//	/* 音频 */
//	DP_M2S_AVBIND_AI2AO=0x0,
//	DP_M2S_AVBIND_AI2AENC,
//	DP_M2S_AVBIND_ADEC2AO,
//
//	/* 视频 */
//	DP_M2S_AVBIND_VI2VO=0x1000,
//	DP_M2S_AVBIND_VI2VENC,
//	DP_M2S_AVBIND_VDEC2VO,
//
//	/* 音视频 */
//	DP_M2S_AVBIND_AI2AENC_VI2VENC=0x2000,
...
//
//    DP_M2S_RC_MODE_H264CBR=0x0,
//    DP_M2S_RC_MODE_H264VBR,
//    DP_M2S_RC_MODE_BUTT
//}DP_M2S_RC_MODE_E;
//
///*
...
//
//    DP_M2S_STREAM_RTSP_SERVER=0x0,
//    DP_M2S_STREAM_RTSP_CLIENT,
...
//}DP_M2S_CMD_ACK_S;
//
///*************************************1.1 DP_M2S_CMD_INIT_BEGIN*************************/
///*
// *说明： 资源初始化开始
// *定义： DP_M2S_CMD_INIT_BEGIN_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_INIT_BEGIN ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_INIT_BEGIN_S;
//
////“资源初始化开始”应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_INIT_BEGIN_RESPOND_S;
//
///*************************************1.2 DP_M2S_CMD_INIT*************************/
///*
// *说明： 资源初始化设置
...
//
///*************************************1.3 DP_M2S_CMD_INIT_END*************************/
///*
// *说明： 资源初始化结束
// *定义： DP_M2S_CMD_INIT_END_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_INIT_END ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_INIT_END_S;
//
////“资源初始化结束”应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_INIT_END_RESPOND_S;
//
///*************************************2.1 DP_M2S_CMD_DEINIT_START*************************/
///*
// *说明： 资源去初始化开始
// *定义： DP_M2S_CMD_DEINIT_START_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_DEINIT_START ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_DEINIT_START_S;
//
////“资源去初始化开始” 应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_DEINIT_START_RESPOND_S;
//
...
//
///*************************************2.3 DP_M2S_CMD_DEINIT_END*************************/
///*
// *说明： 资源去初始化结束
// *定义： DP_M2S_CMD_DEINIT_END_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_DEINIT_END ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_DEINIT_END_S;
//
////“资源去初始化结束” 应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_DEINIT_END_RESPOND_S;
//
///*************************************3.1 DP_M2S_CMD_GETINFO_BEGIN*************************/
///*
// *说明： 信息获取开始
// *定义： DP_M2S_CMD_GETINFO_BEGIN_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_GETINFO_BEGIN ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_GETINFO_BEGIN_S;
//
////“信息获取开始” 应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_GETINFO_BEGIN_RESPOND_S;
//
...
//
///*************************************3.3 DP_M2S_CMD_GETINFO_END*************************/
///*
// *说明： 信息获取结束
// *定义： DP_M2S_CMD_GETINFO_END_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_GETINFO_END ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_GETINFO_END_S;
//
////“信息获取结束” 应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_GETINFO_END_RESPOND_S;
//
///*************************************4.1 DP_M2S_CMD_SETINFO_BEGIN*************************/
///*
// *说明： 信息设置开始
// *定义： DP_M2S_CMD_SETINFO_BEGIN_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_SETINFO_BEGIN ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_SETINFO_BEGIN_S;
//
////“信息设置结束” 应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_SETINFO_BEGIN_RESPOND_S;
//
//
...
//
///*************************************4.3 DP_M2S_CMD_SETINFO_END*************************/
///*
// *说明： 信息设置结束
// *定义： DP_M2S_CMD_SETINFO_END_S
// *成员：
// *	stHeader：协议头，其内容：u16HeadTag + u16PacketLen + DP_M2S_CMD_SETINFO_END ；
// *注意：无
// */
//typedef DP_M2S_INF_PROT_HEAD_S DP_M2S_CMD_SETINFO_END_S;
//
////“信息设置结束” 应答
//typedef DP_M2S_CMD_ACK_S DP_M2S_CMD_SETINFO_END_RESPOND_S;
//
///*************************************5. DP_M2S_CMD_EXIT*************************/
///*
// *说明：程序退出
