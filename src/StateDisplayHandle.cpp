...
//		DP_UDRV_LCD_ShowString(0, 0, (DP_S8*)"DSPPA IDMS4K IN",
//				strlen("DSPPA IDMS4K IN"));
//	} else if (pstRunningInfo->eDevtype == DP_DEV_TYPE_IDMS4K_OUTPUT) {
//		DP_UDRV_LCD_ShowString(0, 0, (DP_S8*)"DSPPA IDMS4K OUT",
...
//		DP_UDRV_LCD_ShowString(0, 1, (DP_S8*)"A", strlen("A"));
//	} else if (pstNetInfo->s32ActiveMacId == 1) {
//		DP_UDRV_LCD_ShowString(0, 1, (DP_S8*)"B", strlen("B"));
//	} else {
